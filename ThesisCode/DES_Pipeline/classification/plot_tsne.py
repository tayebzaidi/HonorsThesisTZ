...
def main():
    ...
    groups = { 0:(2,21,22,23,3,31,32,33),
               1:(1,)}
               #2:( u'Ia Pec', u'Ia-02cx'),
               #3:(u'Ib', u'Ib Pec', u'Ib-n/IIb-n', u'Ib/c',\
               #  u'Ibn', u'Ic', u'Ic BL', u'Ic Pec', u'Ic/Ic-bl'),
    ...
    #Randomize the order of the lightcurves for the random sample
    np.random.permutation(X_scaled)
    X_scaled = X_scaled[0:3000,:]

    #For quick evaluation
    #print("Reducing feature and example size")
    #num_reduce = 100
    #X_scaled = X_scaled[0:num_reduce,:]
    #labels = labels[0:num_reduce]
    #keys = keys[0:num_reduce]
    #colors = colors[0:num_reduce]
    #ucolors = colors[0:num_reduce]
